...
/*************************************/
mess = {
				wait: '*「 WAIT 」 SAD-BOY Sedang Dalam proses*'
}
/******** OWNER NUMBER**********/
	...
	client.on('message-new', async (mek) => {
       ...
       case 'play':
               ...
               if (data.error) return reply(data.error)
                 infomp3 = `「 *PLAY* 」\n*Judul* : ${data.result.title}\n*Duration* : ${data.result.duration}\n*Filesize* : ${data.result.size}\n\n*Tunggu LRF-BOT Sedang mengirim audio nya jangan spam*`
    ...
    break
           ...
           case 'demote':
			...
			if (body.startsWith(`${prefix}${command}`)) {
                  reply(`Maaf *${pushname}*, Command *${prefix}${command}* Tidak Terdaftar Di Dalam *${prefix}menu*! LRF-BOT`)
                  }
